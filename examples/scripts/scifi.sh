...
loc_scene=${basepath}/test/scenes/scifi/scifi.pov
loc_outimg=${basepath}/test/out/loc_scifi.png
loc_width=800 # image width
loc_height=600 # image height
loc_aliasts=3 # antialias threshold
loc_scene_libs=${basepath}/test/scenes/scifi
loc_title="<LOCAL> Render Preview: scifi" # render window title
...
rem_scene=${basepath}/test/conf/scifi.xml
rem_ncpu=1
rem_title="<REMOTE> Render Preview: scifi" # render window title
