...
loc_outimg=${basepath}/test/out/loc_molecule_256.png
loc_width=800 # image width
loc_height=600 # image height
loc_aliasts=3 # antialias threshold
loc_title="<LOCAL> Render Preview: molecule 256" # render window title
...
rem_scene=${basepath}/test/conf/molecule_256.xml
rem_ncpu=1
rem_title="<REMOTE> Render Preview: molecule 256" # render window title
