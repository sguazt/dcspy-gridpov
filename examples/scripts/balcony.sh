...
loc_scene=${basepath}/test/scenes/balcony/balcony.pov
loc_outimg=${basepath}/test/out/loc_balcony.png
loc_width=800 # image width
loc_height=600 # image height
loc_aliasts=3 # antialias threshold
loc_scene_libs=${basepath}/test/scenes/balcony
loc_title="<LOCAL> Render Preview: balcony" # render window title
...
rem_scene=${basepath}/test/conf/balcony.xml
rem_ncpu=1
rem_title="<REMOTE> Render Preview: balcony" # render window title
